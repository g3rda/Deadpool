...
#T=TracerPIN('../target/aes128', processinput, processoutput, ARCH.amd64, 16, addr_range='0x401AD5-0x4028A7', filters=filters, shell=True)
#T=TracerQiling('../target/aes128', processinput, processoutput, ARCH.amd64, 16, addr_range='0x401AD5-0x4028A7', filters=filters, shell=True, record_info=False)
T.run(200)
